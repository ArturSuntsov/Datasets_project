...
QUALITY_PRESETS = {
    "standard": {
        ...
        "golden_pass_threshold": 0.8,
        "golden_sample_ratio": 0.3,
        "annotation_golden_ratio": 0.3,
...
class ProjectSerializer(serializers.Serializer):
    ...
    def _normalize_participant_rules(self, attrs: Dict[str, Any], task_type: str) -> Dict[str, Any]:
        ...
        for key in (
            "golden_min_score",
            "golden_pass_threshold",
            "golden_sample_ratio",
            "annotation_golden_ratio",
