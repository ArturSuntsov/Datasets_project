...
MINIO_PRESIGNED_URL_EXPIRY = int(os.getenv("MINIO_PRESIGNED_URL_EXPIRY", "3600"))

# Настройки валидации файлов
MAX_DATASET_SIZE_MB = int(os.getenv("MAX_DATASET_SIZE_MB", "1024"))  # 1GB по умолчанию
ALLOWED_DATASET_EXTENSIONS = os.getenv(
    "ALLOWED_DATASET_EXTENSIONS",
    "zip,csv,json,parquet,txt,jpg,png"
).split(",")

logger.info(f"MinIO настроен: endpoint={MINIO_ENDPOINT}, bucket={MINIO_BUCKET_NAME}")
logger.info(f"MAX_DATASET_SIZE_MB={MAX_DATASET_SIZE_MB}, ALLOWED_EXTENSIONS={ALLOWED_DATASET_EXTENSIONS}")
