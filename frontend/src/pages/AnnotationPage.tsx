      ...
      {isInfoPanelOpen ? (
        ...
        >
          ...
          >
            ...
            <section className="mt-5">
              <h3 className="text-sm font-semibold">Инструкция</h3>
              <div className="mt-2 max-h-56 overflow-auto whitespace-pre-wrap text-sm text-gray-600 dark:text-gray-400">
